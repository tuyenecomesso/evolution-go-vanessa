...
type Config struct {
	...
	VanessaGatewayMediaWebhookUrl    string
	VanessaGatewayMediaWebhookApiKey string
	ClientName                       string
...
func Load() *Config {
	...
	vanessaGatewayMediaWebhookUrl := os.Getenv(config_env.VANESSA_GATEWAY_MEDIA_WEBHOOK_URL)
	vanessaGatewayMediaWebhookApiKey := os.Getenv(config_env.VANESSA_GATEWAY_MEDIA_WEBHOOK_API_KEY)
	...
	config := &Config{
		...
		VanessaGatewayMediaWebhookUrl:    vanessaGatewayMediaWebhookUrl,
		VanessaGatewayMediaWebhookApiKey: vanessaGatewayMediaWebhookApiKey,
